...
use handlebars::{self, Handlebars, Helper, Output, Renderable, RenderContext, RenderError, to_json};
use serde_json::{self};
...
pub fn camel_helper (h: &Helper, _: &Handlebars, _: &mut RenderContext, out: &mut Output) -> Result<(), RenderError> {
...
pub fn snake_helper (h: &Helper, _: &Handlebars, _: &mut RenderContext, out: &mut Output) -> Result<(), RenderError> {
...
pub fn snake_type_helper (h: &Helper, _: &Handlebars, _: &mut RenderContext, out: &mut Output) -> Result<(), RenderError> {
    let value           = h.param(0).ok_or_else(|| RenderError::new("Param not found for helper \"snake\""))?;
...
pub fn sanitize_name_helper (h: &Helper, _: &Handlebars, _: &mut RenderContext, out: &mut Output) -> Result<(), RenderError> {
...
pub fn each_argument_helper (h: &Helper, r: &Handlebars, rc: &mut RenderContext, out: &mut Output) -> Result<(), RenderError> {
...
pub fn each_flag_helper (h: &Helper, r: &Handlebars, rc: &mut RenderContext, out: &mut Output) -> Result<(), RenderError> {
