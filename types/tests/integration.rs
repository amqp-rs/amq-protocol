...
fn test_full_integration() {
    ...
    table2.insert("foo".into(), AMQPValue::DecimalValue(DecimalValue { scale: 55, value: 999, }));
    table2.insert("baz".into(), AMQPValue::LongString("blah42".into()));

    table.insert("foo".into(),  AMQPValue::FieldArray(vec![AMQPValue::Boolean(true), AMQPValue::Void].into()));
    ...
    table.insert("hhhh".into(), AMQPValue::ByteArray(vec![42, 1, 2, 3].into()));
